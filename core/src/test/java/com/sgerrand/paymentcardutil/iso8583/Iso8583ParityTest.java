 ...
 *
 * <p>Each case was generated by running cardutil itself, so a failure here means
 * the Java port and the Python original disagree, not that a hand written
...
class Iso8583ParityTest {
    ...
    static {
        ...
        if (!Vectors.cardutilVersion().equals("0.7.3")) {
            System.err.println("Vectors came from cardutil " + Vectors.cardutilVersion()
