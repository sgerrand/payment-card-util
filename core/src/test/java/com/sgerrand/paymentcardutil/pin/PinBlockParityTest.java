...
class PinBlockParityTest {
    ...
    Stream<DynamicTest> iso0MatchesCardutil() {
        return Vectors.tests("iso0_pinblock", testCase -> testCase.get("pin").asText() + " on " + testCase.get("card_number").asText(), testCase -> {
    ...
    Stream<DynamicTest> iso0RoundTrips() {
        return Vectors.tests("iso0_pinblock", testCase -> testCase.get("pin").asText(), testCase -> {
            String pin = testCase.get("pin").asText();
            String cardNumber = testCase.get("card_number").asText();
    ...
    Stream<DynamicTest> iso4MatchesCardutil() {
        return Vectors.tests("iso4_pinblock", testCase -> testCase.get("pin").asText(), testCase -> {
