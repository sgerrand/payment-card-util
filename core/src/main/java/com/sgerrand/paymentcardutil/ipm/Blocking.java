 ...
 *
 * <p>The data is cut into runs of {@value #DATA_SIZE} bytes, and two
 * {@code x'40'} bytes are added after each run, making blocks of
 * {@value #BLOCK_SIZE}. The last block is filled out with the same byte so
 * every file is a whole number of blocks.
 */
