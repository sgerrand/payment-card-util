...
public final class Bitmap {
    ...
    /** An empty bitmap with both halves, so fields up to 128 can be set. */
    public static Bitmap emptyWithSecondary() {
        return new Bitmap(new byte[PRIMARY_BYTES + SECONDARY_BYTES]);
    }
